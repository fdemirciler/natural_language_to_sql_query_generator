...
const SchemaVisualizer = ({ schema }) => {
  ...
  // Simplified schema for the World database
  const processedSchema = {
    city: [
      { name: 'id', type: 'integer', isPrimaryKey: true },
      { name: 'name', type: 'text' },
      { name: 'countrycode', type: 'character', isForeignKey: true, references: 'country.code' },
      { name: 'district', type: 'text' },
      { name: 'population', type: 'integer' }
    ],
    country: [
      { name: 'code', type: 'character', isPrimaryKey: true },
      { name: 'name', type: 'text' },
      ...
      { name: 'capital', type: 'integer', isForeignKey: true, references: 'city.id' },
      { name: 'code2', type: 'character' }
    ],
    countrylanguage: [
      { name: 'countrycode', type: 'character', isPrimaryKey: true, isForeignKey: true, references: 'country.code' },
      { name: 'language', type: 'text', isPrimaryKey: true },
